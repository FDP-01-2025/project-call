...
void MountOlympus(){
    string Olympus[] = {
        ...
        "Ves que hay atravez del sello.", // 28
        ...
        "Yo... cuando fui la última vez que senti el sol tocar mi piel...", // 46
        ...
        "Crees que él te llevaria a los campos élieos para derrotar a Hades?.", // 62
        ...
        "Oye Magnus... tu derrotaste a Hade suna vez no es asi?", // 82
        ...
        "Te probare que este chico es dingo del mismo titulo que tu.", // 101
        "Aunque eso nos cueste caro.", // 102
        "Bien... resolvamos esto peleando.", // 103
    ...
    // batalla
        ...
        "O tengas el visto bueno de de otro dios...", // 124
        "Si no has matado no es necesario lo segundo. Pero tambien para ir al infierno tienes que morir o que un dios te lleve.", // 125
        ...
        "Sí... dicho lugar donde antes estaban los Magnus", // 131
        "En cierta sección hay una conexión directamente con él cielo...", // 132
        "Nose porque... se dice que un mago a escondidas hablaba con los dioses olimpicos... pero no saemos para que.", // 133
        ...
        "Y bueno, para derrotar a Hades chico, como eres un gran humano ya tienes la capacidad de hacerlo... pero necesitas tener mucha determinación.", // 139
        "Antes de partir, le dejare dare mi fuerza", // 140
        "Un fragmento de armadura balnca. Que es lo unico que me queda de ella.", // 141
        "Mi arma, la Maxima", // 142
        "y mi magia... Explosion", // 143
        "Gracias por todo...", // 144
