...
// Consolar SI
    ...
    // SI
    "Quien aspiraba al trono era un descendiente del legendario Rey Magnus I, por ello la razón de que sus descendientes sigan teniendo prestigio y muchos seguidores leales...", //399
    "Pero si ganaba significa que nuestro camino pacifista implementado por la Dinastía Aira se viniera abajo...", //400
    "En resumen, después de la caída de los Magnus durante las guerras del peloponeso.", //401
    "Su bisnieta Aira I ya toleraba la naturaleza bélica de Atenas.", //402
    "No le agrada que tanto su pueblo como otros se matarán entre sí. ", //403
    "Así que hizo lo posible para pacificar la región por medios pacíficos.", //404
    "Pero si no lo lograba… usaba la fuerza...", //405
    "Y lo logró...", //406
    "Sabía que Atenas tiene un potencial militar increíble... y Magnus I lo demostró... logró hacer que toda Grecia se arrodillara a sus pies...", //407
    "Pero Aira solo usaba la fuerza necesaria...", //408
    "Si subía al trono la persona equivocada...", //409
    "El equilibrio de poder en la región se desbalancearía...", //410
    "Otros pueblos sufrirán represión...", //411
    "Y llamaría la atención de otros imperios... que no se quedarían de brazos cruzados...", //412
    "Y eso significaba más guerras...", //413
    "Pero muchos atenienses aspiran a que la Grecia bélica vuelva...", //414
    "Volver a ser un imperio...", //415
    "que si bien hubo una Aira que casi domina toda la zona... Aira VII", //416
    "No se acerca ni a los talones del poderoso imperio de Magnus.", //417
    "Y estaba metida en muchos problemas...", //418
    "Muchos atenienses tenían ideologías diferentes...", //419
    "Muchos apoyan la grandeza de Magnus...", //420
    "Y otros abogan por la paz impuesta por Aira I...", //421
    "Y estos últimos estaban decepcionados de no seguir con el camino de sus antecesores...", //422
    "Cuando Aira VII murió...", //423
    "La rivalidad de ideologías explotó...", //424
    "Cada uno tuvo un representante que buscaba el trono...", //425
    "Y ese es el origen de la guerra de sucesión... pero...", //426
    "Esa rivalidad de ideologías perdura hasta nuestros días...", //427
    "Y aunque los rebeldes perdieron... regresaran... pero...", //428
    "Algo me dice que una amenaza mucho más grande está por venir", //429
    // NO
    "",
    };
...
// si es genocida se cancelan los dialogos
        ...
        system("cls");
            ...
            cout << "¿Quieres preguntar algo sobre el contexto del reino?\n1. Sí\n2. No" << endl;

            do {
                cin >> option_tunombre;
                if (option_tunombre < 1 || option_tunombre > 2) {
                    cout << "Por favor selecciona una opción válida (1 o 2)." << endl;
                }
            } while (option_tunombre < 1 || option_tunombre > 2);

            bool DialogueDude = false;
            if (option_tunombre == 1) {
                DialogueDude = true;
            }
